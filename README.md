...
大切な出来事ほど、写真は一枚では収まりません。家族旅行、子どもの成長、誕生日などの思い出は、人物、場所、物、景色といった複数の要素が、それぞれ別の写真に残っています。

けれども、日常に飾る一枚を選ぼうとすると、その出来事らしさの一部を取りこぼしてしまいます。写真は残っていても、見返すには自分から探しに行く必要があり、記録はスマートフォンの中に埋もれがちです。
...
写真と思い出テキストを入力すると、AIが写真群から象徴的な要素を選び、多層の完成案を組み立てます。まず3Dで立体感を確認し、必要な場合だけ2Dで配置や前後関係を整えます。

<table>
  <tr>
    <td width="50%" align="center">
      <strong>1. 写真と思い出を入力</strong><br />
      複数の写真と、写真だけでは伝わらない思い出を入力します。<br /><br />
      <a href="./assets/写真選択画面.jpeg"><img src="./assets/写真選択画面.jpeg" width="260" alt="複数の写真と思い出テキストを入力する画面" /></a>
    </td>
    <td width="50%" align="center">
      <strong>2. AIが作品の完成案を生成</strong><br />
      写真群から残す要素を選び、奥行きを持つ構成を組み立てます。<br /><br />
      <a href="./assets/生成中画面.jpeg"><img src="./assets/生成中画面.jpeg" width="260" alt="AIが思い出を表す要素を探している生成画面" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <strong>3. 3Dプレビューで確認</strong><br />
      レイヤーの前後関係と立体感を、完成前に確認できます。<br /><br />
      <a href="./assets/3Dプレビュー画面.jpeg"><img src="./assets/3Dプレビュー画面.jpeg" width="260" alt="完成案を3Dプレビューで確認する画面" /></a>
    </td>
    <td width="50%" align="center">
      <strong>4. 必要な部分だけ2Dで微調整</strong><br />
      位置・大きさ・レイヤーの前後関係を、自分の思いに合わせて整えます。<br /><br />
      <a href="./assets/2D編集画面.jpeg"><img src="./assets/2D編集画面.jpeg" width="260" alt="レイヤーを2Dで微調整する画面" /></a>
    </td>
  </tr>
</table>
...
最初に、子どもの成長や家族イベントの写真を日常的に残す子育て世代を想定しています。家族旅行、誕生日、入学・卒業、運動会など、多くの写真が残る大切な出来事を、家族で振り返るための作品として扱います。
