 ...
 *   (2026-09-04、担当者共有の実機3Dプリント写真: レイヤーの足元が土台の穴へ
 ...
 *   zFront / baseDepth から計算する(2026-09-04、担当者指摘: 以前はlayerIndex *
 ...
 *   (2026-09-04、担当者追加指示: 足はLayer本体の下端まで伸びて繋がって見えるようにしたい。
 *   低いレール部分の高さ・行そのものの位置は変えない)
 *
 * 背景Layer用の装飾back panelは、実際のLayer画像と別に額縁のような不要な板が
 * もう1枚あるように見えてしまったため廃止(2026-09-04、担当者確認済み)。
...
// (2026-09-04、担当者のスクリーンショットで確認)ため、あえて別の色にして見分けられるようにする
