 ...
 * 2026-09-04、担当者指摘（2D編集でありえない大きさまで拡大できてしまう）を受けて 2 から変更。
 */
 ...
 * （2026-09-04、担当者指摘）。値はここだけで管理し、Componentへ散らさない。
 */
 ...
 * （2026-09-04、担当者報告）。送信前にこのサイズまで縮小して回避する。
 *
 ...
 * 少しだけ詰めた 0.16 を既定値とする（2026-09-04、担当者が実機と見比べて決定）。
 *
 ...
 * 一番手前のLayerがカメラの目の前へ来て圧迫感が出る（2026-09-04、担当者指摘）。
