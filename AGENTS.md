...
| 領域 | 責務 | 担当 |
|---|---|---|
| Frontend | 写真選択、進捗表示、3D Preview、2D Edit、Working Copy管理、作品確定 | 担当者 |
| Backend | API境界、AI Orchestration、Artwork統合・Validation、Asset Manifest返却 | 担当者 |
| AI・画像処理 | 意味理解、Segmentation、象徴要素選定、構成情報生成、Layer Asset生成 | 担当者 |
| Physical Output | 実寸変換、STL等生成、3Dプリント、物理試作 | 担当者 |
| Design / UI | ロゴ、画面構成、UIデザイン | 担当者 |
| 横断支援 | Repository骨組み、AGENTS.md / Skills、Backend支援 | 担当者 |
